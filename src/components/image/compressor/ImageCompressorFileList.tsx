...
interface ImageCompressorFileListProps {
...
export default function ImageCompressorFileList({
  items,
  onRemoveItem,
  onClearAll,
  onAddMoreClick,
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between sm:justify-end gap-3 w-full sm:w-auto border-t sm:border-t-0 border-border-main/40 pt-2 sm:pt-0 shrink-0">
                ...
                {item.status === "concluida" && item.compressedBlobUrl && (
                  <button
                    type="button"
