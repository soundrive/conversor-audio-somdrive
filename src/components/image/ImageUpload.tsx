...
export default function ImageUpload({ onFilesSelected, currentCount, currentTotalSize }: ImageUploadProps) {
  ...
  const validateAndProcessFiles = (rawFiles: FileList | File[]) => {
    ...
    for (const file of filesArray) {
      ...
      const isTypeAllowed = ALLOWED_INPUT_IMAGE_TYPES.includes(file.type.toLowerCase()) || ALLOWED_INPUT_EXTENSIONS.includes(ext);
