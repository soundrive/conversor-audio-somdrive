...
export default function App() {
  ...
  if (currentPath === "/teste/excel-para-pdf-api" || currentPath.startsWith("/teste/excel-para-pdf-api")) {
    return (
      <div className="min-h-screen bg-bg-main text-text-main font-sans p-6 md:p-12">
        <ExcelToPdfApiTest />
      </div>
    );
  }
